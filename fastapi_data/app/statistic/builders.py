...
from fastapi_data.app.statistic.exceptions import (
    BASE_PRINT,
    BinaryColumnsException,
    EmptyColumnException,
    NanColumnsException,
)
from fastapi_data.app.statistic.schemas import ClusteringMethod
...
class OutliersBuilder:
    ...
    def build(
        ...
        suffix = f"_{y_column}" if y_column is not None else ""
        name = f"{method_name}_outliers{suffix}"
